...
const AddProduct = () => {
    ...
    const isPremiumUser = userFromDb?.premiumUser === 'true';
    const uploadedProducts = products.length;
    ...
    return (
        <div>
            {
                !isPremiumUser && uploadedProducts >= 1 ?
                    <div className="text-center text-red-500">
                        <h1 className="text-2xl font-bold mb-6 text-center lg:text-left">
                            You have reached the limit of uploading products. Please <span className='text-green-400 underline cursor-pointer'><Link to={`/dashboard/payment/${subscriptionAmount}`}>Subscribe</Link></span> to upload more products
                        </h1>
                    </div>
                    :
